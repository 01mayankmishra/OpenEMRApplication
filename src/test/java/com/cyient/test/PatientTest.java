...
public class PatientTest extends WebDriverWrapper {
	...
	public void addPatientTest() throws InterruptedException {
		...
		driver.findElement(By.id("form_DOB")).sendKeys("2021-06-09");
		...
		Assert.assertTrue(actualAlertText.contains("New Due Clinical Reminders"));//Validation
		Assert.assertEquals(actualValue, "Medical Record Dashboard - MaK jack");// Validation
	}
